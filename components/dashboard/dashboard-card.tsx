...
const DashboardCard: React.FC<DashboardCardProps> = ({
  ...
  const colorClasses = {
    ...
    green: "from-green-500/20 to-green-400/10 text-green-700 dark:text-green-400",
    purple: "from-purple-500/20 to-purple-400/10 text-purple-700 dark:text-purple-400",
    amber: "from-amber-500/20 to-amber-400/10 text-amber-700 dark:text-amber-400",
    rose: "from-rose-500/20 to-rose-400/10 text-rose-700 dark:text-rose-400",
    indigo: "from-indigo-500/20 to-indigo-400/10 text-indigo-700 dark:text-indigo-400",
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-5">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              {description && (
                <p className="text-xs text-muted-foreground max-w-[85%] leading-snug">
                  {description}
                </p>
              )}
            </div>
        ...
        <div className={cn(
          ...
          `bg-gradient-to-r from-${color}-500 to-${color}-300 group-hover:h-1.5`
        )} />
      </Card>
    </motion.div>
  );
