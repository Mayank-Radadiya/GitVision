-- Custom migration: Add RAG support tables and columns
...
ALTER TABLE "code_embeddings" ADD CONSTRAINT "code_embeddings_file_id_project_files_id_fk" 
	FOREIGN KEY ("file_id") REFERENCES "public"."project_files"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "chat_messages" ADD CONSTRAINT "chat_messages_chat_id_project_chats_id_fk" 
	FOREIGN KEY ("chat_id") REFERENCES "public"."project_chats"("id") ON DELETE cascade ON UPDATE no action;
